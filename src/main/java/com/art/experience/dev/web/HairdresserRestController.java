...
public class HairdresserRestController {
    ...
    @GetMapping("/all/works/{id_hairdresser}")
    @ResponseStatus(HttpStatus.OK)
    public List<Work> getAllWorksById(@PathVariable("id_hairdresser") final Long hairdresserId) {
        return hairdresserService.getAllWorksForHairdresserId(hairdresserId);
    }
