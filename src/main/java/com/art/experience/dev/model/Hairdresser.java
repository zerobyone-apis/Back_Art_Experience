...
public class Hairdresser implements Serializable {
    ...
    private Long rateOfHairdresser;
    @Column(name = "amount_of_reserves_day")
    private Long amountOfReservesByDay;
    @Column(name = "status")
    ...
    public Long getAmountOfReservesByDay() {
        return amountOfReservesByDay;
    }

    public void setAmountOfReservesByDay(Long amountOfReservesByDay) {
    ...
    public Long getRateOfHairdresser() {
        return rateOfHairdresser;
    }

    public void setRateOfHairdresser(Long rateOfHairdresser) {
